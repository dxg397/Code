...
function  dWji= numer_est_Wji(Wji,Wkj,b1_vec,b2_vec,training_patterns,targets)
temp =size(targets);
...
[rmserr,esqd] = err_eval(Wji,Wkj,b1_vec,b2_vec,training_patterns,targets);
dWji=0*Wji;
eps=0.000001;
%Wji
for j=1:J
    for i=1:I
       ...
       % Wtemp
        [temp1,esqd2]=err_eval(Wtemp,Wkj,b1_vec,b2_vec,training_patterns,targets);
        dout=esqd2-esqd;
        dWji(j,i)=dout/eps;
    end
end
