...
int main(int argc, char **argv) {
    ros::init(argc, argv, "asg1_minimal_simulator"); //name this node 
    ...
    ros::Subscriber my_subscriber_object = nh.subscribe("asg1_cmd", 1, myCallback);
    ...
    double sample_rate = 100000.0 / dt; // compute the corresponding update frequency 
